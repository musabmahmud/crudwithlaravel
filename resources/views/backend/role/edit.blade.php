                                ...
                                <div class="card-body">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control @error('role_name') is invalid @enderror"
                                            id="role_name" name="role_name" value="{{ $role->name }}"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="custom-control custom-checkbox">
                                          <input {{ ($role->hasPermissionTo($permission)) ? "checked" : "" }}  class="custom-control-input" type="checkbox" id="customCheckbox{{$permission->id}}" value="{{$permission->id}}" name="permissions[]">
