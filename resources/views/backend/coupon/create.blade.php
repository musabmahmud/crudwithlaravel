                        ...
                        <div class="card card-primary">
                            ...
                            <form action="{{route('coupon.store')}}" method="POST">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        <label for="coupon_amount">Coupon Amount(1 to 100)%</label>
                                        <input type="number" class="form-control @error('coupon_amount') is invalid @enderror" min="0" max="99" id="coupon_amount" name="coupon_amount" value="{{ old('coupon_amount') }}"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="date" class="form-control @error('coupon_validity') is invalid @enderror"
                                            id="coupon_validity" name="coupon_validity" value="{{ old('coupon_validity') }}"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="number" max="100" min="0" class="form-control @error('coupon_limit') is invalid @enderror"
                                            id="coupon_limit" name="coupon_limit" value="{{ old('coupon_limit') }}"
