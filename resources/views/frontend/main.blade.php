            ...
            <div class="row">
                <div class="col-12">
                    <div class="featured-active2 owl-carousel next-prev-style">
                        ...
                        <div class="featured-wrap">
                            <div class="featured-img">
                                <img src="{{ asset('frontend/images/featured/7.jpg')}}" alt="">
                                <div class="featured-content">
                        ...
                        <div class="featured-wrap">
                            <div class="featured-img">
                                <img src="{{ asset('frontend/images/featured/8.jpg')}}" alt="">
                                <div class="featured-content">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="section-title">
                        ...
                        <img src="{{ asset('frontend/images/section-title.png') }}" alt="Our Latest Product">
                    </div>
                </div>
            </div>
            <ul class="row">
                @foreach ($latests as $latest)
                    <li class="col-xl-3 col-lg-4 col-sm-6 col-12">
                        <div class="product-wrap">
                            <div class="product-img">
                                ...
                                <img src="{{ asset('productImage/' . $latest->thumbnail) }}" alt="{{ $latest->title }}">
                                <div class="product-icon flex-style">
                                    <ul>
                                        <li><a data-toggle="modal" data-target="#product{{$latest->id}}"
                                                href="javascript:void(0);"><i class="fa fa-eye"></i></a></li>
                                        <li><a href="wishlist.html"><i class="fa fa-heart"></i></a></li>
                                        <li><a href="cart.html"><i class="fa fa-shopping-bag"></i></a></li>
                                    </ul>
                            ...
                            <div class="product-content">
                                ...
                                <p class="pull-left">
                                    @if (collect($latest->attribute)->min('sale_price'))
                                        ${{collect($latest->attribute)->min('sale_price')}}
                                    @else
                                        ${{collect($latest->attribute)->min('regular_price')}}
                                    @endif
                                </p>
                                <ul class="pull-right d-flex">
                                    <li><i class="fa fa-star"></i></li>
                    ...
                    <div class="modal fade" id="product{{$latest->id}}" tabindex="-1">
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body d-flex">
                                    <div class="product-single-img w-50">
                                        <img src="{{ asset('productImage/' . $latest->thumbnail) }}"
                                            alt="{{ $latest->title }}">
                                    </div>
                                    <div class="product-single-content w-50">
                                        ...
                                        <ul class="cetagory">
                                            <table>
                                                <tr>
                                                    <td>Categories:</td>
                                                    <td><a href="#">{{ $latest->category->category_name }}</a></td>
                                                </tr>
                                                <tr>
                                                    <td>Sub Categories:</td>
                                                    <td><a href="#">{{ $latest->subcategory->subcategory_name }}</a></td>
                                                </tr>
                                            </table>
                                        </ul>
                                        <ul class="socil-icon">
